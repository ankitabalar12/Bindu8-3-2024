...
const SomethingWentWrong = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Image source={icons.error} style={styles.updateimages}></Image>
            <Text style={styles.textstyle}>{String.Upsfound}</Text>
            <Text style={styles.Performancetext}>{String.Pleasesearch}</Text>
            <GreenButton
